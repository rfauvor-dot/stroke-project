...
export const PHOTOS = {
  kettle: {
    // Swapped 2026-07-18 for Rick's photo — a real stovetop whistling
    // kettle, matching the SFA cue text ("has a spout and whistles")
    // better than the electric kettle used before.
    url: "./photos/kettle.png",
  ...
  stairs: {
    // Swapped twice on 2026-07-18: original Wikimedia pick (Modulightor
    // Building) was a cluttered architectural interior shot that read as
    // "bookshelf"/"room" — only verified via text metadata, not the actual
    // image. A CC-licensed spiral staircase fixed that, but Rick's own
    // Gemini-generated photo (a real home staircase, wood + blue runner) is
    // a better everyday-recognizable match, so using that as final.
    url: "./photos/stairs.png",
    credit: "Supplied by Rick",
    license: "AI-generated by Rick (Google Gemini) — ownership confirmed 2026-07-18, both platforms grant full commercial/redistribution rights to the user",
    sourcePage: null,
  },
  library: {
  ...
  towel: {
    // Swapped 2026-07-18 for Rick's photo — folded towel on a bathroom
    // shelf, a clearer everyday context than the flat studio shot before.
    url: "./photos/towel.png",
    credit: "Supplied by Rick",
    license: "AI-generated by Rick (ChatGPT/DALL-E or Google Gemini) — ownership confirmed 2026-07-18, both platforms grant full commercial/redistribution rights to the user",
    sourcePage: null,
  },
  ...
  spoon: {
    // Swapped 2026-07-18 for Rick's photo — a single spoon, cleaner match
    // than the two-spoon comparison shot used before (wasn't asked for,
    // but was included in the same batch and is a genuine improvement).
    url: "./photos/spoon.png",
    credit: "Supplied by Rick",
    license: "AI-generated by Rick (ChatGPT/DALL-E or Google Gemini) — ownership confirmed 2026-07-18, both platforms grant full commercial/redistribution rights to the user",
    sourcePage: null,
  },
  ...
  toothbrush: {
    // Swapped 2026-07-18 for Rick's photo — single toothbrush, cleaner
    // than the "toothbrushes in a cup" (plural) shot used before.
    url: "./photos/toothbrush.png",
    credit: "Supplied by Rick",
    license: "AI-generated by Rick (ChatGPT/DALL-E or Google Gemini) — ownership confirmed 2026-07-18, both platforms grant full commercial/redistribution rights to the user",
    sourcePage: null,
  },
  soap: {
    // Swapped 2026-07-18 for Rick's photo — bar of soap on a bathroom
    // dish, clearer everyday context than the studio product shot before.
    url: "./photos/soap.png",
    credit: "Supplied by Rick",
    license: "AI-generated by Rick (ChatGPT/DALL-E or Google Gemini) — ownership confirmed 2026-07-18, both platforms grant full commercial/redistribution rights to the user",
    sourcePage: null,
  ...
  // People set. Deliberately relational, not generic stock photos:
  // neighbor shows the "waving over the fence" association from the word's
  // own SFA data, grandson shows a child's hand reaching an elder's rather
  // than a full face.
  husband: {
    // Swapped 2026-07-18: original was hands + wedding ring (no face,
    // deliberately avoiding a generic face for a relational word). Rick's
    // replacement is a smiling portrait with the ring visible near the
    // face — his call to show a face this time.
